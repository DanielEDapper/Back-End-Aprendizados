    ...
    public static void menuRealizarEntrega()
    {
        ...
        try{
            ...
            for(Entrega entrega : entregas)
            {
                ...
                {
                    Entrega entregaAtualizacao = new Entrega(entrega.getIdEntrega(), entrega.getIdPedido(), entrega.getIdMotorista(), entrega.getDataSaida(), entrega.getDataEntrega(), entrega.)
                }
            }
        }
