...
public class EntregaDao 
{
    ...
    // SQL para atualizar o status e a data de entrega final
    ...
    try (Connection conn = ConnectionFactory.conectar();
        ...
        // Uso de java.time conforme requisito técnico [2]
        stmt.setObject(2, entrega.getDataEntrega()); 
        
        stmt.setInt(3, entrega.getIdEntrega());
