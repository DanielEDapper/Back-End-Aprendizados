...
public class MenuMotorista 
{
    ...
    public static void menuRealizarEntrega()
    {
        ...
        try{
            ...
            for(Entrega entrega : entregas)
            {
                if(entrega.getIdEntrega() == idEntrega)
                {
                    Entrega entregaAtualizacao = new Entrega(entrega.getIdEntrega(), entrega.getIdPedido(), entrega.getIdMotorista(), entrega.getDataSaida(), entrega.getDataEntrega(), entrega.getStatusEntrega());

                    entregaService.atualizarEntrega(entregaAtualizacao);
                }
            }
        }
