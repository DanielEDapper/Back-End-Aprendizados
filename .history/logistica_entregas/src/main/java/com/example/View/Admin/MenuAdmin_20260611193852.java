...
public class MenuAdmin 
{
    ...
    public static void menuAdminInicio()
    {
        ...
        while(continuar)
        {
            ...
            System.out.println("==  [10] - Cancelar Entrega");
    ...
    public static void cadastrarMotorista()
    {
        ...
        System.out.print("==  Digite a cidade base: ");
    ...
    public static void excluirMotorista()
    {
        ...
        try{
            ...
            for(Motorista motorista : motoristas)
            {
                System.out.println("  ");
                System.out.println("============================================================");
                System.out.println("==  ID: "+motorista.getIdCliente());
                System.out.println("==  NOME: "+motorista.getNome());
                System.out.println("==  CPF/CNPJ: "+motorista.getCpfCnpj());
                System.out.println("==  ENDEREÇO: "+motorista.getEndereco());
                System.out.println("==  CIDADE: "+motorista.getCidade());
                System.out.println("==  ESTADO: "+motorista.getEstado());
                System.out.println("============================================================");
                System.out.println("  ");
            }
        }
    ...
    {
        System.out.println("============================================================");
        System.out.println("==      RELATÓRIO: CLIENTE COM MAIS VOLUME ENTREGUE       ==");
        System.out.println("============================================================");
    ...
    public static void cancelarEntrega()
    {
        System.out.println("============================================================");
        System.out.println("==                   CANCELAR ENTREGA                     ==");
        System.out.println("============================================================");
        ...
        try{
            ...
            System.out.println(Ferramentas.BORDEAUX+"============================================================");
            System.out.println("==             CONFIRMAÇÃO DE CANCELAMENTO                ==");
            System.out.println("============================================================");
            System.out.println("==  Para confirmar o cancelamento digite 'cancelar' abaixo");
            System.out.print("==  Digite: "+Ferramentas.RESET);
            String msgConf = Ferramentas.lString();

            if(msgConf.equals("cancelar"))
            {
