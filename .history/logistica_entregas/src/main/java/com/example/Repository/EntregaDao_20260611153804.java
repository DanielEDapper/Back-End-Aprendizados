...
public class EntregaDao 
{
    ...
    public static List<EntregaResponse> relatorioEntregasPorClienteEMotorista()
    {
        String sql = """
                SELECT 
                e.id AS entrega_id,
                c.nome AS nome_cliente,     -- Vem da tabela Cliente
                m.nome AS nome_motorista,   -- Vem da tabela Motorista
                p.data_pedido,              -- Vem da tabela Pedido
                e.status AS status_entrega   -- Vem da tabela Entrega
            FROM entrega e
