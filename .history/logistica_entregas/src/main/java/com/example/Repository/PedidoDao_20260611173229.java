...
public class PedidoDao 
{
    ...
    public static HashMap<Integer, String> relatorioPedidoPendenteEstado() throws SQLException
    {
        HashMap<Integer, String> pedidosPendentes = new HashMap<>();
        ...
        try(Connection conn = ConnectionFactory.conectar();
            PreparedStatement stmt = conn.prepareStatement(sql))
            {
                ...
                while(rs.next())
                {
                    ...
                    pedidosPendentes.put(null, estados)
                }
            }
    }
}
