...
public class EntregaDao 
{
    ...
    public static Entrega buscarEntrega(int idEntrega) throws SQLException
    {
            ...
            PreparedStatement stmt = conn.prepareStatement(sql))
        {
            ...
            return new Entrega(rs.getInt("id"), rs.getInt("pedido_id"), rs.getInt("motorista_id"), rs.getObject("data_saida", LocalDateTime.class), rs.getObject("data_entrega", LocalDateTime.class), rs.);
        }
