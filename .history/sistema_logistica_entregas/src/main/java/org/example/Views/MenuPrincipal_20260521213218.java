...
public class MenuPrincipal 
{
    ...
    public static void menuAdmin()
    {
        ...
        switch(opcao)
        {
            case 1 -> ViewAdmin.criarCliente();
            case 2 -> ViewAdmin.criarMotorista();
            case 3 -> ViewAdmin.relatorioEntregasPorMotorista();
            case 4 -> ViewAdmin.relatorioClienteMaiorVolume();
            case 5 -> ViewAdmin.pedidoPendentePorEstado();
            case 6 -> ViewAdmin.entregasAtrasadasCidade();
            case 7 -> ViewAdmin.listarEntregasClienteMotorista();
            case 8 -> ViewAdmin.excluirMotorista();
            case 9 -> ViewAdmin.excluirCliente();
            case 0 -> sair();
        }
    }
